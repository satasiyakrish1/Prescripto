...
const userSchema = new mongoose.Schema({
    ...
    // Notification preferences for realtime + delivery
    notificationSettings: {
        ...
        // updatedAt to help clients resolve races and show last change time
    ...
    // Auto-cancellation penalty tracking
