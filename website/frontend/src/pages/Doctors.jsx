    ...
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden animate-pulse">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-1 mb-4">
          ...
          <div className="h-4 w-10 bg-gray-200 dark:bg-gray-700 rounded ml-1"></div>
        </div>
...
const Doctors = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 pt-8 md:pt-12" ref={doctorsRef}>
      <SEO
        title={seoTitle}
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6 search-controls">
        <div className="relative flex-grow">
          <input
            ...
            className="w-full p-3 pl-4 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 dark:text-white"
            value={searchTerm}
        ...
        <div className="flex gap-3">
          <select
            ...
            className="p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 p-3 border border-gray-300 dark:border-gray-600 rounded-lg md:hidden bg-white dark:bg-gray-800 dark:text-white"
          >
            <Filter size={20} />
            <span>Filters</span>
          </button>
        ...
        <div className={`md:w-64 filter-sidebar ${showFilter ? 'block' : 'hidden md:block'}`}>
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-semibold text-gray-800 dark:text-white">Specialities</h3>
              <button
            ...
            <div className="flex flex-col gap-2">
              <div
                ...
                className={`px-4 py-2 rounded-md cursor-pointer transition-all ${!speciality ? ' #5f6FFF text-primary-700 dark:text-primary-400 font-medium' : 'hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-300'}`}
              >
                All Specialities
              </div>
              ...
              {specialties.map((spec, index) => (
                <div
                  ...
                  className={`px-4 py-2 rounded-md cursor-pointer transition-all ${speciality === spec ? ' #5f6FFF text-primary-700 dark:text-primary-400 font-medium' : 'hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-300'}`}
                >
                  {spec}
                </div>
              ))}
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              />
              <h3 className="text-xl font-medium text-gray-800 dark:text-white">No doctors found</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filterDoc.map((doctor) => (
                <div
                  ...
                  className="doctor-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden cursor-pointer hover:shadow-lg transition-all duration-300"
                >
                  <div className="relative h-48  #5f6FFF">
                    <img
                    ...
                    <div className="absolute top-3 right-3 flex gap-2">
                      <button
                        ...
                        className={`p-2 rounded-full ${likedDoctors[doctor._id] ? 'bg-red-500 text-white' : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-white'} shadow-md hover:scale-105 transition-all`}
                      >
                        <Heart size={18} fill={likedDoctors[doctor._id] ? "currentColor" : "none"} />
                      </button>
                      <button
                        onClick={(e) => handleShare(e, doctor)}
                        className="p-2 bg-white dark:bg-gray-700 text-gray-700 dark:text-white rounded-full shadow-md hover:scale-105 transition-all"
                      >
                        <Share2 size={18} />
                      </button>
                    </div>
                  ...
                  <div className="p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={`text-sm ${doctor.available ? 'text-green-600' : 'text-gray-500 dark:text-gray-400'}`}>
                        {doctor.available ? 'Available Now' : 'Not Available'}
                      </span>
                    </div>

                    <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-1">{doctor.name || 'Doctor Name'}</h3>
                    <p className="text-blue-600 dark:text-blue-400 text-sm font-medium mb-2">{doctor.speciality || 'Specialist'}</p>
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700">
                      <button className="w-full py-2 bg-primary-600 dark:bg-primary-500 hover:bg-blue-700 text-white rounded-md transition-colors">
                        Book Appointment
                      </button>
                    </div>
                  </div>
