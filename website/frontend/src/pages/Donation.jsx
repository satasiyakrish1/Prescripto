      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl md:col-span-3 border border-blue-100">
          ...
          <form onSubmit={handleDonation} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-primary text-white py-4 rounded-xl hover:bg-primary-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center"
              disabled={loading}
            >
              {loading ? (
        ...
        <div className="md:col-span-2">
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100 h-full">
            ...
            <div className="space-y-4">
              <div className="flex items-start p-3  #5f6FFF rounded-xl">
            ...
            <div className="mt-6 p-4  #5f6FFF rounded-xl border border-blue-100">
