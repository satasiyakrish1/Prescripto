      ...
      <div className="space-y-4">
        {faqs.map((faq, idx) => (
          <div key={idx} className="border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm">
            <button
              className="w-full flex justify-between items-center px-6 py-4 text-lg font-medium text-left focus:outline-none focus:bg-primary-50 hover:bg-primary-50 transition"
              onClick={() => toggle(idx)}
