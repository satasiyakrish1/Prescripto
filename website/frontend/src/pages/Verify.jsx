                ...
                <div className="max-w-md mx-auto">
                    <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
                        ...
                        <button 
                            ...
                            className="w-full bg-gradient-to-r from-primary to-indigo-600 hover:from-primary-600 hover:to-indigo-700 text-white font-semibold py-3 px-6 rounded-xl transition duration-300 transform hover:scale-105"
                        >
                            Go to Profile
                        </button>
                    </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-primary-50 to-indigo-100 py-12 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-primary to-indigo-600 rounded-full mb-6">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                        Get <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600">Verified</span>
                    </h1>
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        Join our verified community and earn trust with the verification badge. 
                            ...
                            {plans.map((plan, index) => (
                                <div 
                                    ...
                                    className={`relative bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer ${
                                        selectedPlan?.id === plan.id ? 'ring-4 ring-primary ring-opacity-50' : ''
                                    } ${index === 1 ? 'md:scale-105 border-2 border-primary-200' : ''}`}
                                    onClick={() => handleSelectPlan(plan)}
                                >
                                    {index === 1 && (
                                        <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-primary to-indigo-600 text-white text-center py-2 text-sm font-semibold">
                                            Most Popular
                                        </div>
                                    )}
                                    ...
                                    <div className={`p-8 ${index === 1 ? 'pt-12' : ''}`}>
                                        <div className="text-center">
                                            ...
                                            <div className="flex items-center justify-center mb-4">
                                                <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600">
                                                    ₹{plan.price}
                                                </span>
                                            </div>
                        ...
                        {selectedPlan && (
                            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md mx-auto">
                                ...
                                <button 
                                    ...
                                    className="w-full bg-gradient-to-r from-primary to-indigo-600 hover:from-primary-600 hover:to-indigo-700 text-white font-semibold py-4 px-6 rounded-xl transition duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                >
                                    {paymentLoading ? (
                                        <div className="flex items-center justify-center">
