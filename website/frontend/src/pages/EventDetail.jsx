                ...
                {userRsvp ? (
                  ...
                  <form onSubmit={handleRsvpSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-3">
                      ...
                      <button
                        type="submit"
                        disabled={paymentProcessing}
                        className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                      >
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className={`w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white ${isRsvpButtonDisabled() ? 'bg-gray-400 cursor-not-allowed' : 'bg-primary-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'}`}
                    >
                      {getRsvpButtonText()}
                    </button>
