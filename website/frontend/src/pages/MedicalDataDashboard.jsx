        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col items-center gap-4">
              <button
                onClick={handleInstallExtension}
                className="flex items-center gap-2 bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover: #5f6FFF transition-all shadow-lg"
              >
                <Chrome size={24} />
                Download Extension
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!parsedData && (
          <div className="mb-10 max-w-2xl mx-auto">
            <h2 className="text-xl font-semibold mb-4 text-primary-700">Upload Medical Store Data</h2>

            <div
              {...getRootProps()}
              className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${isDragActive ? "border-blue-500  #5f6FFF" : "border-gray-300 hover:border-blue-400"}`}
            >
              <input {...getInputProps()} />
