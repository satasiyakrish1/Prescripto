...
<g id="OBJECTS">
    ...
    return (
        <div className="container mx-auto py-6">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-center mb-2 text-purple-700 dark:text-purple-400">Suggested Cosmetic Products</h1>
                <p className="text-center text-gray-600 dark:text-gray-400 mb-6">Find and explore beauty products from top brands</p>
                ...
                <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4 mb-6">
                    <div className="flex-grow">
                        <input
                            ...
                            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500"
                            value={searchQuery}
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-md mb-6 border border-gray-200 dark:border-gray-700">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-pink-500"
                                >
                            ...
                            <div>
                                ...
                                <input type="number" name="priceMin" placeholder="Min" min="0" step="0.01" value={filters.priceMin} onChange={handleFilterChange}
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-pink-500" />
                            </div>

                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Max Price ($)</label>
                                <input type="number" name="priceMax" placeholder="Max" min="0" step="0.01" value={filters.priceMax} onChange={handleFilterChange}
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-pink-500" />
                            </div>
                        </div>
                        ...
                        <div className="mt-4 flex justify-end">
                            <button
                                ...
                                className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors mr-2"
                            >
                                Clear Filters
                            </button>
                            <button
            ...
            {!loading && cosmetics.length > 0 && (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {cosmetics.map((cosmetic) => (
                        <div
                            key={cosmetic.id}
                            className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 cursor-pointer border border-transparent dark:border-gray-700"
                        ...
                        >
                            ...
                            <div className="p-4">
                                <p className="text-sm text-purple-600 dark:text-purple-400 font-medium mb-1">{cosmetic.brand}</p>
                                <h3 className="font-bold text-gray-800 dark:text-white mb-2 line-clamp-2">{cosmetic.name}</h3>
