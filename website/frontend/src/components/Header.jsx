...
const Header = () => {
    return (
        <div className='relative flex flex-col md:flex-row flex-wrap bg-primary dark:bg-primary-700 rounded-lg px-6 md:px-10 lg:px-20 overflow-hidden mt-8 md:mt-12'>


            {/* --------- Header Left --------- */}
            <div className='relative md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[calc(6vw+10px)] md:mb-[-30px]'>
                ...
                <div className='flex gap-4 animate-fade-in-up animation-delay-300'>
                    <a href='#speciality' className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300' style={{ color: '#131313ff' }}>
